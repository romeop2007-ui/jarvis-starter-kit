---
name: "source-command-semaine"
description: "Migrated source command `semaine`"
---

# source-command-semaine

Use this skill when the user asks to run the migrated source command `semaine`.
...
Capture les blocages identifiés et les choses à préparer côté Codex.
