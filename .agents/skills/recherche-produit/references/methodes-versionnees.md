...
## Journal — session 20 (09/09/2026, recherche produit en tâche de fond pendant le testing PureShot)

**Consigne de Roméo** : continuer à innover sur des filtres tant qu'aucun signal ne sort, rejouer les filtres validés qui n'ont pas tourné depuis longtemps (F35, F38, F41, F42, F43, F47, F48 — tous datés 06-08/08/2026, jamais retestés depuis un mois), sur des marchés pas encore explorés récemment (ES/PT/IT, DE/AT/NL/BE/PL et Nordique ont déjà tourné hier via F74/F70/F71, cf. session du 08/09).

**11 passes de découverte + 14 vérifications de dispersion, 0 candidat validé.**

**Filtres validés rejoués (résultat par filtre) :**
- **F43** (V1 + plafond de likes) : 20 résultats, rien de neuf franchissant le plancher. Meilleure piste (Villanisartoria, bomber IT) tuée sur niche féminine + narratif « fermeture après 27 ans » (même famille que Holmgaard).
- **F41** (signature dropshipper frais + vitesse) : 20 résultats, dominé par le déjà-vu (Marina Roca, déjà retenu la veille) et des exclusions dures (Nervia ingéré, Core Armour déjà rejeté).
- **F42** (F41 + fenêtre de prix) : RAS, même lot que F41.
- **F38** (F37 + plancher de prix) : Sanifera/KneePlex (bande rotulienne genou, IT) et Cervia SE (dispositif décompression cervicale, SE) sortis ici — les deux seuls candidats de la catégorie douleur/orthopédie réouverte à avoir été creusés à fond cette session, cf. verdicts ci-dessous.
- **F47** (fenêtre d'ancienneté + exclusion FR) : gisement confirmé épuisé dès la page 1 — **page 2 rendue à 0 résultat**, cohérent avec la note du catalogue « F47 se joue en page 1 ».
- **F48** (marchés fort pouvoir d'achat + prix plancher) : relancé SANS `shop_created_after` par erreur de ma part (bug de frappe, pas un défaut du filtre) → n'a fait remonter que des accumulateurs anciens (92 à 613 jours de diffusion : Huber-Outdoor déjà rejeté, Monsori déjà vu). **À refaire correctement avec la fraîcheur avant de tirer une conclusion sur F48.**
- **F35** (plancher direct + techno + shop semi-frais) : confirme son diagnostic d'origine — que du déjà-vu (Mara Santos, Urban Smartwatch, Marina Roca) et une nouvelle exclusion (Sportgeist, maillots de foot personnalisés nom+numéro = personnalisable + risque contrefaçon license sportive).

**2 filtres neufs inventés (rotation de marchés jamais isolés seuls dans le catalogue) :**

### 🧪 F76 — Rotation Ibérie/Balkans/CEE (PT, GR, IE, CZ, HU, PL, SK, RO)

```
technologies: ["shopify"], max_traffic: 2000, max_facebook_likes: 1500
shop_created_after: <6 mois, min_reach: 80000 (last7d)
ad_countries: {include: ["PT","GR","IE","CZ","HU","PL","SK","RO"]}
max_ads_per_brand: 1, sort_by: reachDelta7d
```
Hypothèse : ces 8 marchés sont statistiquement moins regardés par les 700 élèves de la formation (qui restent sur FR/DE/IT/ES/UK). **Testé le 09/09/2026 : 20 résultats, dominés par un pattern répété — advertorial santé façon témoignage médical fictif** (« Dra. Ana Dumitrescu », « Dra. Catarina Lopes Recomenda », toutes deux avec le même texte d'ouverture « Menti a uma mãe / I-am minți unei mame... » traduit dans chaque langue), exclusion dure santé systématique. Le reste : bijouterie générique (Amelia Praha), reseller B2B professionnel (MVP Distribuições, exclu — vend à des salons, pas au grand public), shop généraliste enfant (Rodzicielstwo w Praktyce, contenu parental, pas un produit). **Aucun candidat neuf.** ⏸️ En pause : le filtre fonctionne techniquement mais le gisement de ces 8 marchés semble saturé par le même pattern d'advertorial santé traduit en série — à re-tester en excluant `LEARN_MORE`/`ORDER_NOW` pour couper ce pattern si retenté.

### ⏸️ F77 — Rotation Baltique + GB/IE (LT, LV, EE, GB, IE)

```
technologies: ["shopify"], max_traffic: 2000, max_facebook_likes: 1500
shop_created_after: <6 mois, min_reach: 100000 (last7d)
main_countries: ["LT","LV","EE","GB","IE"]
max_ads_per_brand: 1, sort_by: reachDelta7d
```
**Testé le 09/09/2026 : 0 résultat balte** (LT/LV/EE trop petits pour ce plancher de reach), mais le marché GB a produit deux pistes. **Weeklyard.co.uk** (Royaume-Uni, 946 €/j sur sa meilleure créa) — tué : shop **généraliste multi-produits éphémères** (sculpture déco chien vintage, calendriers de l'avent Noël à thème chihuahua/rallye/champagne/squishy, breloque commémorative WWII), aucun mono-produit à copier, la moitié du catalogue est saisonnier Noël en plein mois de septembre. **Trykavira.com** (brosse à cheveux premium façon hôtel de luxe, GB, advertorial « I cleaned The Ritz ») — 1 seule créa ≥30k reach trouvée, dispersion insuffisante pour juger. ⏸️ En pause : la Baltique seule est trop petite pour ce plancher (à retester avec un `min_reach` abaissé à ~30-50k si isolée sans GB/IE), le duo GB/IE se comporte comme du marché classique sans avantage particulier.

**Autres pistes creusées et tuées (dispersion insuffisante ou exclusion), toutes documentées dans `liste-rejetes.md`** : Vindstad/Woodsnord (chaussures SE, image trompeuse marque HOKA), RobotVerde (robot tondeuse revendu, IT, 1 seule créa), V-ello (gant anti-poils, DE, 1 seule créa), Sturzfest (pantalon protection moto DE, 2/6 créas au plancher — le plus proche d'un candidat cette session, mis en veille), My Mancini (sneakers personnalisables + marque italienne déjà installée avec boutiques physiques), Playio (jouet évier à eau pour enfant PL, 2 créas proches du plancher mais shop généraliste jouets + saisonnier été).

**Verdict de session : aucun candidat ne franchit le plancher complet.** Trois profils mis en veille avec condition de réouverture chiffrée (KneePlex, Cervia, Sturzfest) — cf. `liste-rejetes.md`. Conforme à la doctrine : un résultat nul honnête plutôt qu'un candidat forcé, mais innovation de filtres bien tentée (F76, F77) avant de conclure.

---

## Journal — session 21 (09/09/2026, relance immédiate après session 20 sur consigne explicite de Roméo)

**Consigne** : ne pas rejouer les passes exactes de la session 20 (F76 Ibérie/Balkans/CEE et F77 Baltique/GB/IE, tous deux fermés/quasi fermés), privilégier le BrandTracker en premier réflexe, puis mixer filtres validés récents (F70/F71/F74, jamais utilisés en session 20 qui n'avait rejoué que d'anciens filtres F35-F48) et filtres neufs.

**BrandTracker en premier réflexe** : `list_tracked_brands` (14 marques suivies) puis `get_brandtracker_scaling_ads` sur les signaux de fraîcheur les plus forts (`newAdsLast7Days`) : **Harley Wellness USA** (nouvelle marque suivie, 29 nouvelles créas/7j) — creusé en premier car jamais vu au catalogue, mais **toutes ses créas actives sont mortes** (reach 21 à 898, spend 0-8€, page à 1 seul pays) : advertorial en test qui n'a jamais décollé, probablement un complément/CBD pour animaux vu le narratif (chat âgé, "stage 2 kidney..."), de toute façon inexploitable côté data. **LederKur** (rejeté le 07/08 sur dispersion, 191 nouvelles créas/7j) et **ScandicBeam DK** (36 nouvelles créas/7j) re-vérifiés en tri "current_rank" puis en tri reach global sur leurs créas actives : confirment tous deux leur rejet d'origine (LederKur toujours 0 créa au-dessus de 2 000 reach individuel malgré le volume ; ScandicBeam toujours au même prix cassé ~35 €, créas fraîches à 96-117 reach chacune). **Nattly DK** (123 nouvelles créas/7j) re-vérifié : toujours EnkelDyne, toujours sous le plancher, nouveau domaine `sovna.store` ajouté à la famille sans rien changer sur le fond. **Aucun candidat neuf via BrandTracker cette fois.**

**11 passes `search_ads`/`search_shops` au total, aucune ne rejoue une combinaison exacte de la session 20 :**

| # | Passe | Résultat |
|---|-------|----------|
| 1 | **F74** (plancher par page 220k/7j + fraîcheur créa 8-45j + dédup levée à 5, tri `reachDelta7d`) | 4 groupes de produits distincts. `playio.pl` (déjà tué session 20), `huber-outdoor.at` (déjà en réserve, toujours 1 seule créa ≥70€/j), `wombea.com` (stick "rellenador" PDRN = filler anti-âge topique, exclusion dure santé), `ivernovo.com`/**finamora.com** ("Viocore2", 4-5 créas ≥70€/j sur des URLs différentes — creusé, voir ci-dessous, tué). |
| 2 | **F70** (concentration en €, `min_spend_per_page`≥1500/7j) | 20 lignes, presque toutes déjà vues. 4 nouvelles pistes creusées (`m.kaufjoy.de`, `drompod.de`, `trynubo.co.uk`, `lumiluxlight.com`) — toutes tuées, voir ci-dessous. |
| 3-6 | **Dispersion/vérification** sur `kaufjoy.de`, `drompod.de` (+ 2e requête plancher élargi), `trynubo.co.uk`, `lumiluxlight.com` | Détaillé ci-dessous, 0 candidat. |
| 7 | **V1** (`min_active_ads`≥40, `max_traffic`2000, shop <6 sem, `reachDelta7d`) | 20 lignes, dominées par du contenu politique brésilien/dating-advertorial (le filtre shop `max_traffic` ne mord pas sur les sites non-shop). 2 pistes creusées (`respeno.pl` oreiller enfant = cluster déjà connu, `titanexofficiel.com` poêle titane FR = cluster déjà connu). Rien de neuf actionnable. |
| 8 | **V4 sans `max_traffic`** (test de contrôle volontaire) | Confirme une 4e fois la loi corollaire n°2 : sans plafond de trafic, la sortie est 100 % bruit (candidat politique, CNC $2799, sites de rencontre, merch Backstreet Boys). Pas un filtre à réutiliser tel quel, juste une re-confirmation. |
| 9 | **F69** (plancher créa seul, sans `min_active_ads`) | 20 lignes, tout déjà vu (récits de fermeture de bijouterie type Holmgaard/Mara Santos, VORO montres, Core Armour). Rien de neuf. |
| 10 | **Saisonnier N-1 (novembre 2025)**, `status: all`, `min_reach 400k total` | Confirme le constat de la session 16 : le gisement de novembre est dominé par des cadeaux personnalisés (magnete/schieferherz/armband gravés, tous exclusion dure) et des marques déjà installées (BENU, Bulldog, Liquid IV). Rien de nouveau par rapport à octobre. |
| 11 | **`search_shops` `ads_growth`≥80%/30j**, shop peu de produits, marchés EU | 143 shops au total, champs `activeAds`/`monthlyVisits` non renseignés par défaut. 2 domaines distinctifs creusés en `search_ads` (`dopemirrors.com`, `flexlum.eu`) — tous deux des marques déjà installées (voir ci-dessous), pas des dropshippers frais. |

**Détail des candidats creusés et tués :**

- **`ivernovo.com` / `finamora.com`** ("Viocore2 by Rolimey") — 4-5 créas ≥70€/j sur des variantes d'URL différentes (kj7甲, kj3鬆, kj1血, kj8冠, kj4痱), ce qui semblait franchir le plancher haut la main. Page produit ouverte (redirection confirmée : `ivernovo.com` redirige vers `finamora.com`) : c'est un **dentifrice ciblé pour "régénération parentale" (periodontal regeneration), revendication FDA-approved "GEM 21S" explicite de traitement de maladie des gencives**. Exclusion dure double : topique à promesse santé (traite une pathologie) + prix 22,97 £ de toute façon sous le plancher logistique (~40€).
- **`wombea.com`** (Espagne) — "Stick rellenador de biocolágeno PDRN" = stick filler anti-âge à base de PDRN, appliqué sur le visage. Exclusion dure : topique à promesse santé/anti-âge (même famille que sérums anti-rides déjà exclus). 1 seule créa nette ≥70€/j de toute façon (184€/j), sous le plancher de 3.
- **`m.kaufjoy.de`** — pas un shop mono-produit : c'est une plateforme de "funnel" allemande qui pousse des dizaines de gadgets sans rapport (effaceur de rayures auto, lime à ongles électrique, sacs de conservation alimentaire, support téléphone, kit DIY Noël, grille de friteuse, déboucheur, ôte-callosités...) sous plusieurs pages Facebook différentes (Testomaplus, Dein KaufTipp, Mitideen). Généraliste, non copiable comme un seul produit.
- **`drompod.de`** (DrömPod, Suède) — coussin correcteur anti-ronflement, "recommandé par des chiropracteurs", 2 créas ≥70€/j (231€/j et 190€/j) sur deux variantes de la même page advertorial, donc **sous le plancher de 3**. Vérification du catalogue (`/products.json`) : le shop est en réalité **généraliste multi-produits sommeil/voyage** (8 coussins différents, nasal strips, matelas de sol "Nordrest", masseur "SpineRelief", bracelet vibrant, **lanyard anti-vol téléphone "SummitLock"**) vendu simultanément en SE/DK/NO/FI **ET en FRANÇAIS** ("l'Oreiller-Thérapie" à 109,90€, déjà en vente FR). Double motif de rejet : généraliste + déjà présent en France. Signal d'alerte additionnel : les créas les plus fortes tournent sous 3 pages Facebook à noms de personnes différentes (Välmående Idag, Sara Andersson 217 pubs, Bättre sömn) poussant la même page produit — ferme d'advertorial à profils multiples, pas un shop unique.
- **`trynubo.co.uk`** (Nubo, Royaume-Uni) — coussin de posture pour enfant avec promesse de "corriger la formation du visage/mâchoire de l'enfant par la position de sommeil". Sur la page produit réelle (`/products/posture-pillow`), seulement 1 créa ≥70€/j (128€/j) sur 3 mesurées, sous le plancher. Même famille déjà tuée le 06/08/2026 (Sennly/Calina, "promesse santé agressive sur le développement du visage de l'enfant") — cluster confirmé mais toujours sous les seuils requis.
- **`lumiluxlight.com`** (LumiLux, DE/AT) — lampe d'ambiance "aurora". Marque déjà installée (10,4M de reach total, créas principales en diffusion depuis 385-408 jours), 1 seule créa fraîche (13j) au-dessus du plancher. Pas un dropshipper frais.
- **`dopemirrors.com`** — rétroviseurs moto adventure. Marque de niche déjà établie (badge partenaire Meta, 12,9k abonnés IG, garantie à vie revendiquée), diffusion internationale depuis plusieurs mois, aucune créa au-dessus de 16€/j de dépense. Pas un candidat frais.
- **`flexlum.eu`** — lampe frontale 230° à capteur de mouvement. **Même produit exact que Huber-Outdoor** (cluster déjà connu), mais ici une marque bien plus grosse et bien plus ancienne (13,8M reach total, diffusion simultanée IT/HU/EE/HR depuis janvier 2026, revendication "500 000+ utilisateurs", encadrée "remise d'hiver" = narratif saisonnier). Confirme que le cluster lampe frontale 230° est déjà occupé par au moins 2 gros acteurs (Huber-Outdoor + Flexlum), en plus de Roméo qui a déjà cette catégorie en réserve.

**Filtres rejoués vs inventés** : sur les 11 passes, **aucune ne reprend une combinaison déjà utilisée à l'identique en session 20** (qui avait tourné sur F35/F38/F41/F42/F43/F47/F48 + F76/F77). Session 21 a mobilisé F74, F70, V1, V4 (test de contrôle), F69, la recherche saisonnière officielle, et un renouvellement `search_shops` par croissance de pubs — tous des filtres déjà validés/documentés au catalogue mais non joués depuis 3 à 6 jours (F74/F70 datent du 03/09, V1/V4/F69 du 02/09, le saisonnier du 02/09 pour octobre, jamais fait pour novembre avant aujourd'hui).

**Verdict de session 21 : 0 candidat validé, 0 nouveau statut de veille.** Tous les profils touchés étaient soit déjà connus (clusters lampe frontale, poêle titane, oreiller enfant, montres, bijouterie "fermeture"), soit neufs mais tués sur exclusion dure (Viocore2, WomBea) ou sur structure de shop (kaufjoy généraliste, drompod généraliste+FR). Le gisement EU frais et copiable reste aussi mince que documenté par la mesure du 03/09 (population à un chiffre) : deux sessions consécutives avec les meilleurs filtres du catalogue plus le BrandTracker en premier réflexe ne suffisent pas à en sortir un candidat. Aucun changement à la doctrine ni au catalogue de filtres n'est nécessaire — c'est une confirmation, pas une découverte méthodologique.

---

## Journal — session 22 (09/09/2026, 3e relance de la journée, consigne explicite de persévérance de Roméo)

**Consigne** : « on continue la recherche produit jusqu'à en trouver plus. » Deux sessions précédentes le même jour (20 et 21) avaient déjà rejoué F35/F38/F41/F42/F43/F47/F48/F76/F77 puis F74/F70/V1/V4/F69/saisonnier-novembre/`search_shops` growth — toutes à 0 candidat. Consigne : explorer des angles vraiment neufs, pas encore joués aujourd'hui : F51/F53 rejoués (dernière fois le 02/09, une semaine), F57/F62/F63 (dernière fois le 02/09), Italie et Espagne seules en profondeur, DE+AT+CH, `daily_radar`, filet nordique dédié, et un F78 inédit si le reste est épuisé.

**13 passes menées, 0 candidat validé, 1 profil mis en veille.**

| # | Passe | Résultat |
|---|-------|----------|
| 1 | `daily_radar` (focus scaling, 14 brandtrackers) | 10 créas remontées, 100 % déjà connues (ScandicBeam, Nattly/EnkelDyne, LederKur — nouveau hook "confession de sellier" mais même produit déjà rejeté, Monveree, Aurenis, Mannenkamer). Rien de neuf. |
| 2 | **F51 rejoué** (`search_shops`, `growth30d`, EU-15, shop <4 mois) | 51 shops au total, 30 lus. Rien de neuf exploitable : `oldpatek.de/.com` (correction posturale orteil — vérifié ensuite **0 pub active**, mort), `skim-patches.com` (patchs sommeil, topique), `korean-essence.se`/`lineabeauty.se` (topiques déjà rejetés), `nordband.se` (même produit que NordBand déjà rejeté, domaine sœur), `mybeet.pl`/`vitalurge.com`/`viitaluxe.com` (ingérés), `invictusnutrition.co.za` (reseller whey, hors EU), `broto.pt`/`kidorakids.dk` (déjà connus, sous plancher), le reste hors-sujet (billetterie concert, ebook, marché AR/EG/ZA/US). |
| 3 | **F53 rejoué** (`search_shops`, tri `createdAt`, EU-15) | 51 shops au total (population quasi identique à F51 sur cet échantillon reposé). `nervosense.de` (douleur/brûlure pied, dispositif — pas topique-santé au sens strict mais très proche), `neuro-pur.de`, `autwild.at` (déjà connu, saisonnier), `ciriel.co.uk`/`zomesi.com` (déjà connus, dispersion), `lymphoria` (ingéré déjà connu), `sleepynightsco.se` (déjà dans la mesure du gisement à 8 shops). Rien de neuf. |
| 4 | **F74** (plancher par page 220k/7j, dédup levée à 5, tri `reachDelta7d`, monde entier) | 4 groupes : Playio (jouets enfant PL, saisonnier rentrée), Huber-Outdoor (déjà en réserve), WomBea (topique anti-âge, exclusion), LumiLux (déjà connu, marque installée). Rien de neuf. |
| 5 | **F74 page 2** | Calmora (spray magnésium douleur/nerfs, GB — voir F78 ci-dessous, même marque), Marina Roca (déjà retenu au pipeline), Norelia Boutique (bague bijou IT, niche féminine), RichBe UK (déjà rejeté, généraliste), Nervia (ingéré déjà connu), Arxajo (sandales orthopédiques ES — voir ci-dessous), Ticket Maestro (billetterie, pas un produit). Rien de neuf. |
| 6 | **🧪 F78 — Croissance du REACH DE PAGE (`page_reach_growth`, jamais utilisé dans tout le catalogue)** | `page_reach_growth: [{period:last7d, comparison:greater, value:80}]` + fenêtre créa 8-45j + `technologies:shopify` + `max_traffic:2500` + `max_facebook_likes:1500` + `/products/` + `ad_countries.exclude:FR`. Dérivée jamais exploitée (le catalogue n'avait utilisé que `ad_reach_growth` au niveau CRÉA et `ads_growth`/`traffic_growth` au niveau shop — jamais la croissance de reach au niveau PAGE). **Résultat : 15 lignes, mélange de déjà-connus et de 2 profils neufs** (Calmora, Arxajo), tous deux tués (détail ci-dessous). Signal correct (pas de bruit type marques mondiales), mais échantillon encore trop petit pour trancher V/❌. **Reste 🧪 en test**, à relancer sur un nouvel échantillon avant jugement définitif. |
| 7 | **F74 restreint Italie seule** (`main_countries:["IT"]`) | Sanifera/KneePlex (déjà en veille depuis session 20), SOVA Italia (Ovastart, inositol PCOS — ingéré, exclusion), Elisa Conti/viveaprotect.com (dispositif anti-étouffement — voir ci-dessous), Hobbies Laboratory (sac à dos personnalisé prénom enfant — exclusion dure personnalisable). 1 profil mis en veille (viveaprotect.com), rien de validé. |
| 8 | **F74 restreint Espagne seule** (`main_countries:["ES"]`) | WomBea, Nervia/Colectivo de Médicos (même produit ingéré, 2e page Facebook), KneePlex (déjà en veille), Vikguirao SHOP (agenda scolaire — marque installée, 54 612 abonnés IG, pas un dropshipper frais). Rien de neuf. |
| 9 | **F74 restreint DE+AT+CH** (`main_countries`) | **Confirme une 4e fois la loi corollaire n°6** : l'API renvoie explicitement `"main_countries only covers Meta's EU/UK ad transparency set, so CH matches no ad"`. Résultats DE/AT : Huber-Outdoor, LumiLux, Asileap (généraliste confirmé — mastic étanchéité + clip volumateur cheveux + lunch box, 3 produits différents sous le même shop), Berlinmood (généraliste gadgets, y compris le même mastic étanchéité qu'Asileap = produit générique revendu par plusieurs fermes), ArtiTree (sapin de Noël artificiel, marque installée 21M reach, saisonnier), Engel-Kette (collier gravé, personnalisable, exclusion dure), Dein KaufTipp (généraliste DIY, famille kaufjoy déjà rejetée). Rien de neuf. |
| 10 | **Filet nordique dédié** (`search_shops`, SE/DK/NO/FI/DE/NL/AT, `max_products_count:10`, shop <6 mois) | 50 shops au total. `billpill.de`/`wohlkraut.de`/`cinnexa.com` (ingérés), `sunfitshop.no`/`alexanderregen.com` (niche féminine + devise NOK/USD = angles morts), `clearairnorge.com` (stick nasal, NOK = angle mort Norvège), `adyro.eu` (chaussures homme "PRIMO 2.0" — voir ci-dessous, mort), `filterboxdanmark.com`/`ekohemshop.dk`/`kidorakids.dk`/`neuro-pur.de` (déjà connus), `viafeet.se` (bas de contention, SEK, sous 40 pubs, non creusé faute de signal). Rien de neuf. |
| 11 | **Vérification domaine `oldpatek.de`/`.com`** (correction posturale orteil, catégorie douleur/posture réouverte) | **0 résultat sur `search_ads` par domaine** : le shop n'a plus aucune pub active malgré son apparition dans le tri `growth30d`. Mort, invérifiable en l'état. |
| 12 | **Vérification domaine `arxajo.com`** (sandales orthopédiques ES, `dolor de pies/fascitis plantar/juanetes`) | **1 seule créa ≥50k reach au total** (85 023 reach / 37j ≈ 112 €/j), la 2e à 9 317/26j ≈ 3,2 €/j. **Dispersion (loi n°5), sous le plancher de 3.** S'ajoute : niche féminine explicite (« miles de mujeres »), hors périmètre de sourcing. |
