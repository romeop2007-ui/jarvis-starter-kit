...
allowed-tools: WebSearch, WebFetch, Bash(python .Codex/skills/recherche-logement-huesca/scripts/*), mcp__claude_ai_Notion__notion-fetch, mcp__claude_ai_Notion__notion-update-page, mcp__claude_ai_Notion__notion-search
---
...
4. Distance à pied :
   ```bash
   python .Codex/skills/recherche-logement-huesca/scripts/geocode_distance.py "<adresse ou rue>, Huesca"
   ```
