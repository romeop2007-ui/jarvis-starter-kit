...
- **🇬🇧 Boutique UK Sculpted** — Structure Shopify terminée + rebrandée Sculpted, thème poussé sur cqqah9-t1.myshopify.com. Page panier `/cart` créée et en ligne (31/05/2026) : corrige la 404 de l'icône caddie ET du logo au checkout (tous deux pointaient vers `/cart` qui n'existait pas). Bundle "Buy 2 Get 1 Free" fonctionnel. Plusieurs sections homepage/produit converties en **emplacements image unique 1254×1254** (témoignages, size guide, bénéfices, how it works, image droite de Stats) et **cadres UGC passés en lecteur vidéo** (02/06/2026). Photos produit récupérées par Roméo (OK de son côté). Guide des tailles passé en **pop-up image (1440×1440)** sur accueil + produit, comparatif mobile rendu lisible, espace ajouté entre avis et badges (03/06/2026). **Reste à faire : uploader les visuels 1254×1254 + les vidéos UGC dans l'éditeur Shopify, uploader l'image du guide des tailles 1440×1440 dans la pop-up (accueil + produit), tester le parcours de bout en bout, créer le Meta BM, adapter les 5-6 créas en anglais. Lancement ads au sprint #1 (13 juin).**
...
- 🟡 **Adaptation des créas en anglais** — Workflow posé le 03/06/2026 : Vmake AI (efface les sous-titres FR incrustés) → ElevenLabs (voix off UK) → CapCut (montage + sous-titres EN). Claude fournit les scripts traduits FR vers anglais UK. Méthode "traduire avant d'innover" appliquée aux 5-6 créas gagnantes d'underfitmen.com. **Décision en suspens : brancher ElevenLabs en MCP pour générer les voix directement, ou rester sur l'app.** Prochaine action : Roméo envoie la transcription FR de la 1re créa.
