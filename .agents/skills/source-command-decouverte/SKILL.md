---
name: "source-command-decouverte"
description: "Migrated source command `decouverte`"
---

# source-command-decouverte

Use this skill when the user asks to run the migrated source command `decouverte`.

## Command Template

# /decouverte

> Session dédiée de 10 min où Codex pose à Roméo 3 à 5 questions hors-sujet pour enrichir le contexte.
...
Voir `.Codex/skills/connaissance-mutuelle/SKILL.md` pour le déroulé complet, les 6 catégories de questions, et les règles.
