...
- **Cle Google** : `.google-service-account.json` a la racine du workspace (compte de service `budget-bot@Codex-gws-setup-497511.iam.gserviceaccount.com`, partage en Editeur sur le Sheet). Gitignoree.
...
- Lignes (nature) : 3 Codex IA · 4 Shopify · 5 LegalPlace · 6 TrendTrack · 7 Qonto · 8 Vmake · 9 ElevenLabs · 10 Capcut · 11 Zecom
